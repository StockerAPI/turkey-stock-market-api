# Turkey stock market API

Real-time Turkey stock market API with WebSocket, OHLCV, and snapshot endpoints for BIST.

## Overview

Kun Data provides real-time market data for Turkey through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Turkey market coverage with support for BIST.

## API Capabilities

- Real-time WebSocket market data for Turkey
...
This repository is designed to make Turkey market API coverage easier to discover and evaluate.
