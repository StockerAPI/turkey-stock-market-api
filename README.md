...
## Build With Turkey Market Data

Kun Data provides a token-authenticated API stack for developers who need Turkey market data in products that must load fast, stream live prices, and support charting or screening workflows.
...
### Does this support real-time Turkey market data?
...
If you need Turkey market data coverage for BIST, start with the product page and documentation:
