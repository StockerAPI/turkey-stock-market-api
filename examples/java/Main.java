...
public class Main {
    ...
    private static final String MARKET = "TR";
    private static final String EXCHANGE = "BIST";
    private static final String SYMBOL = "BIST:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"BIST:000040\",\"BIST:005930\"],\"replay\":\"last\"}";
